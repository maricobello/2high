...
/** Frase do modelo de êxito (remuneração só sobre o valor efetivamente recuperado). */
export function successFeeText(): string {
  return brand.successFee ? `Remuneração de ${brand.successFee} sobre o valor recuperado` : "Remuneração apenas sobre o valor recuperado";
}
