  ...
  return (
    <div
      ...
      className={cn(
        ...
        dark ? "border-white/10 bg-ink-2 text-white hover:border-white/20" : "border-border bg-white hover:border-primary/30 hover:shadow-[0_20px_50px_-20px_rgba(61,90,254,0.35)]",
        className,
      )}
    >
      <div
        ...
        style={{
          background: `radial-gradient(420px circle at var(--mx, 50%) var(--my, 50%), ${dark ? "rgba(52,211,240,0.14)" : "rgba(61,90,254,0.10)"}, transparent 45%)`,
        }}
      />
