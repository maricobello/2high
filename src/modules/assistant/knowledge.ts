...
export const SERVICE_FACTS = [
  ...
  "Recuperação de valores: quando a distribuidora fatura a maior por erro dela, a REN ANEEL 1.000/2021 (art. 323) prevê devolução em dobro, com correção, salvo quando a causa é do consumidor. Para empresas, o CDC só se aplica em casos de vulnerabilidade; a base principal é a regra da ANEEL.",
  "A auditoria revisa pelo menos os últimos 5 anos (60 faturas); em alguns casos o prazo de devolução pode ser maior. O pedido começa pela via administrativa (distribuidora, ouvidoria e ANEEL), que resolve boa parte dos erros de faturamento, sem garantia de resultado. ICMS pago a mais é tratado com a Secretaria da Fazenda, não com a distribuidora. O resultado depende da comprovação; não há garantia de valores.",
  ...
  "Modelo de êxito: diagnóstico e auditoria não têm custo; se houver valor a recuperar, a remuneração é um percentual do valor efetivamente recuperado, definido em contrato antes de começar. Sem mensalidade; sem recuperação, não há cobrança.",
  "Laudo de crédito de ICMS: indústrias fora do Simples Nacional podem se creditar do ICMS da energia consumida na produção (LC 87/96, art. 33), com laudo de engenharia que mede essa parcela; o crédito pode alcançar 5 anos, conforme as regras de cada estado, e abate ICMS a pagar. No Grupo A, o ICMS só incide sobre a demanda efetivamente utilizada (Súmula 391 do STJ; STF, Tema 176).",
